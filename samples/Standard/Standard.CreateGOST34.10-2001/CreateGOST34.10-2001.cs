    ...
    *************************************************************************/
    ...
    class CreateGOST3410_2001
    {
        ...
        static readonly List<IObjectAttribute> PublicKeyAttributes1 = new List<IObjectAttribute>
        {
            ...
            Helpers.factories.ObjectAttributeFactory.Create((uint) CKA.CKA_GOSTR3411_PARAMS, SampleConstants.GostR3411Parameters)
        };
        ...
        static readonly List<IObjectAttribute> PublicKeyAttributes2 = new List<IObjectAttribute>
        {
            ...
            Helpers.factories.ObjectAttributeFactory.Create(CKA.CKA_CLASS, CKO.CKO_PUBLIC_KEY),
            // Метка ключа
            Helpers.factories.ObjectAttributeFactory.Create(CKA.CKA_LABEL, SampleConstants.GostPublicKeyLabel2),
        ...
        static readonly List<IObjectAttribute> PrivateKeyAttributes2 = new List<IObjectAttribute>
        {
            ...
            Helpers.factories.ObjectAttributeFactory.Create(CKA.CKA_CLASS, CKO.CKO_PRIVATE_KEY),
            // Метка ключа
            Helpers.factories.ObjectAttributeFactory.Create(CKA.CKA_LABEL, SampleConstants.GostPrivateKeyLabel2),
            // Идентификатор ключевой пары #2 (должен совпадать у открытого и закрытого ключей)
            Helpers.factories.ObjectAttributeFactory.Create(CKA.CKA_ID, SampleConstants.GostKeyPairId2),
            // Тип ключа - ГОСТ Р 34.10-2001
            Helpers.factories.ObjectAttributeFactory.Create(CKA.CKA_KEY_TYPE, (uint) CKK.CKK_GOSTR3410),
