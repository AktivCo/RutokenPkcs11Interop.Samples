...
namespace Standard.VKO_GOST3410_2012_256
{
    /*************************************************************************
    * Rutoken                                                                *
    ...
    class VKO_GOST3410_2012_256
    {
            ...
            byte[] ukm, out IObjectHandle derivedKeyHandle)
        {
            ...
            var deriveMechanismParams =
                Helpers.factories.RutokenMechanismParamsFactory.CreateCkGostR3410_12_256_DeriveParams(
                    (uint)Extended_CKD.CKD_KDF_GOSTR3411_2012_256, SampleData.PublicKeyData_256, ukm);
