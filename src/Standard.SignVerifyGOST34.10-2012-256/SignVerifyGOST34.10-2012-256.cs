...
namespace Standard.SignVerifyGOST3410_2012_256
{
    /*************************************************************************
    * Rutoken                                                                *
    ...
    *************************************************************************/
    ...
    class SignVerifyGOST3410_2012_256
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (var pkcs11 = Helpers.factories.RutokenPkcs11LibraryFactory.LoadRutokenPkcs11Library(Helpers.factories, Settings.RutokenEcpDllDefaultPath, AppType.MultiThreaded))
                {
                    ...
                    bool isGostR3410_256Supported = mechanisms.Contains((CKM)CKM.CKM_GOSTR3410);
                    bool isGostR3411_12_256Supported = mechanisms.Contains((CKM)Extended_CKM.CKM_GOSTR3411_12_256);
                    Errors.Check(" CKM_GOSTR3410_256 isn`t supported!", isGostR3410_256Supported);
                    ...
                    using (IRutokenSession session = slot.OpenRutokenSession(SessionType.ReadWrite))
                    {
                        ...
                        try
                        {
                            ...
                            var mechanism = Helpers.factories.MechanismFactory.Create((uint)Extended_CKM.CKM_GOSTR3411_12_256);
                            ...
                            var signMechanism = Helpers.factories.MechanismFactory.Create((uint)CKM.CKM_GOSTR3410);
