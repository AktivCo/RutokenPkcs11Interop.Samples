...
namespace PKIExtensions.DeleteObjects_GOST3410_2001
{
    /*************************************************************************
    * Rutoken                                                                *
    ...
    *  - поиск ключевой пары ГОСТ 34.10-2001 и сертификата на Рутокен;       *
    ...
    * PKIExtensions.CreateCSR-PKCS10-GOST34.10-2001                          *
    * и PKIExtensions.ImportCertificate-GOST34.10-2001                       *
    *************************************************************************/

    class DeleteObjects_GOST3410_2001
    {
